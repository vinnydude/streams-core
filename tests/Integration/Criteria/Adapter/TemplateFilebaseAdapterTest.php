...
namespace Streams\Tests\Core\Integration\Criteria\Adapter;

use Illuminate\Support\Facades\File;
use Streams\Core\Support\Facades\Streams;
use Streams\Tests\Core\Integration\Criteria\CriteriaTest;

class TemplateFilebaseAdapterTest extends CriteriaTest
{
    ...
    protected function removeData()
    {
        ...
        File::deleteDirectory(base_path('streams/data/films/' . Streams::make('films')->config('source.format', 'tpl')));
    }
