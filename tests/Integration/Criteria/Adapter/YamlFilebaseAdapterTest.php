...
class YamlFilebaseAdapterTest extends CriteriaTest
{
    ...
    protected function removeData()
    {
        ...
        File::deleteDirectory(base_path('streams/data/films/' . Streams::make('films')->config('source.format', 'yaml')));
    }
